...
public class AuthService {
    ...
    private void sendVerificationEmail(User newUser) {
        ...
        try {
            // Frontend page calls the API — avoids raw JSON in the browser
            String link = appBaseUrl + "/verify-email?token=" + newUser.getVerificationToken();
    ...
    public AuthResponse login(LoginRequest request) {
        ...
        if (requireEmailVerification && !existingUser.isEmailVerified()) {
