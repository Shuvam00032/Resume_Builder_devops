...
const LandingPage = () => {
  ...
  return (
    <div className="w-full min-h-full bg-white">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <button
                  type="button"
                  disabled={loading}
                  className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-full hover:shadow-xl transition-all duration-300 font-semibold text-lg flex items-center justify-center gap-2 group disabled:opacity-60 disabled:cursor-wait disabled:hover:shadow-none"
                  onClick={handleCTA}
                >
                  Start Building Now
                ...
                <button
                  type="button"
                  className="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-full hover:border-purple-400 hover:text-purple-700 transition-colors font-semibold text-lg"
      ...
      <section
        id="templates"
        className="py-20 bg-gradient-to-b from-white to-slate-50 scroll-mt-24"
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-14">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Pick a layout designed for ATS systems and hiring managers—then make it yours in minutes.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {resumeTemplates.map((template) => (
              <div
                key={template.id}
                className="group rounded-2xl overflow-hidden border border-gray-200 bg-white shadow-md hover:shadow-xl hover:border-purple-200 transition-all duration-300"
              >
                ...
                <div className="p-4 flex items-center justify-between gap-2 border-t border-gray-100">
          ...
          <div className="text-center mt-12">
            <button
              type="button"
              disabled={loading}
              className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-3 rounded-full font-semibold hover:shadow-lg transition-all disabled:opacity-60 disabled:cursor-wait"
              onClick={handleCTA}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:shadow-xl transition-all duration-300">
              ...
              <button 
                type="button"
                disabled={loading}
                className="w-full bg-gray-100 text-gray-800 py-3 rounded-xl font-semibold hover:bg-gray-200 transition-colors disabled:opacity-60 disabled:cursor-wait"
                onClick={handleCTA}
              >
                Get Started Free
              </button>
            ...
            <div className="bg-gradient-to-br from-blue-600 to-purple-600 text-white rounded-2xl p-8 relative overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <button 
                type="button"
                disabled={loading}
                className="w-full bg-white text-blue-600 py-3 rounded-xl font-semibold hover:bg-gray-50 transition-colors disabled:opacity-60 disabled:cursor-wait"
                onClick={handleCTA}
              >
                Upgrade to Premium
              </button>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <button
            type="button"
            disabled={loading}
            className="bg-white text-blue-600 px-8 py-4 rounded-full font-semibold text-lg hover:shadow-xl transition-all duration-300 inline-flex items-center gap-2 group disabled:opacity-60 disabled:cursor-wait"
            onClick={handleCTA}
          >
            Start Building Now
            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
